...
<header>
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header"><a class="navbar-brand" href="select.php">20/21シーズン　プレミアリーグ試合結果</a></div>
    </div>
  </nav>
</header>
...
<label>試合日:<input type="date" name="date"></input></label><br>
...
<p>得点<br>
   ...
   <label><textarea name="hometext" rows="5" cols="40">【フォーメーション】【ゴール】【交代】【レビュー】</textarea></label><br>
...
<!-- アウェイチーム -->
 ...
 <p>得点<br>
   ...
   <textarea name="awaytext" rows="5" cols="40">【フォーメーション】【ゴール】【交代】【レビュー】</textarea><br>
